          ...
          <Box sx={{ ...uiConfigs.style.mainContent }}>
            <Box sx={{
              ...
              <Box sx={{
                ...
                <Stack spacing={2}>
                  <Typography variant="h5" fontWeight="700" fontFamily={'"Doppio One", sans-serif'} >
                    {`${person.name} (${person.birthday && person.birthday.split("-")[0]}`}
                    {person.deathday && ` - ${person.deathday && person.deathday.split("-")[0]}`}
                    {")"}
                  </Typography>
                  <Typography sx={{ ...uiConfigs.style.typoLines(10) }} fontFamily={'"Averia Sans Libre", sans-serif'}>
                    {person.biography}
                  </Typography>
                </Stack>
              </Box>
