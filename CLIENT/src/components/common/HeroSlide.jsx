...
import yourImage from "./scroll.webp";
      ...
      >
              ...
              >
                <Stack spacing={4} direction="column">
                  ...
                  <Typography
                    ...
                    style={{ fontFamily: '"Autour One", system-ui' }}
                  >
        ...
        <Box
          sx={{
            ...
            zIndex: 3,
            filter: "invert(1)", // Invert the colors for white background
            "@media (prefers-color-scheme: dark)": {
              // Media query for dark mode
              filter: themeMode === themeModes.dark ? "invert(0)" : "invert(1)",
            },
          }}
          onClick={handleImageClick} // Attach click event handler
        >
          <img
            src={yourImage}
            alt="Scroll"
